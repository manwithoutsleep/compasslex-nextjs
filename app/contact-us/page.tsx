          ...
          <div>
            <div className="mb-6">
              <p className="text-deep-sapphire mb-4 text-base">
                ...
                Road and exit at Alumni Drive (travel south away from Lexington city center). Take
                the first left onto Perimeter Drive, 651 Perimeter is the six-story glass office
                building on the left, Suite 115 is on the 1st floor.
              </p>
              <Image
