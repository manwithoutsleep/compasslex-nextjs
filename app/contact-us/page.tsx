                ...
                <div className="flex flex-wrap justify-evenly gap-8">
                    ...
                    <div className="w-full max-w-[475px]">
                        <p className="mb-6 text-base">
                            Call us with questions! Often we are in session and will not be able to
                            answer the phone, but please leave a message and we will make every
                            effort to return your call in a timely manner.
                        </p>
                        <div>
                    ...
                    <div className="w-full max-w-[475px]">
                        <div className="mb-6">
                            <p className="mb-4 text-base">
                                We are located at the corner of New Circle Road and Alumni Drive.
                                Take New Circle Road and exit at Alumni Drive (travel south away
                                from Lexington city center). Take the first left onto Perimeter
                                Drive, 651 Perimeter is the six-story glass office building on the
                                left, Suite 115 is on the 1st floor.
                            </p>
                            <Image
