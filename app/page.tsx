        ...
        <div className="mb-10">
          <div className="border-bengal-blue bg-polar-mist mx-auto max-w-3xl rounded border p-6">
            <p className="text-deep-sapphire text-base leading-relaxed">
              ...
              in a new direction. The first thing we&apos;ll do is listen without judgment. Then,
              we&apos;ll walk alongside of you on your journey. Together we will create solutions
              and new possibilities that will help you reach your goals. We all have a unique path
              we take through life&hellip; and sometimes we just need a little help along the way.
            </p>
          </div>
        </div>
        ...
        <div className="mb-10 grid grid-cols-1 gap-6 md:grid-cols-2">
          ...
          <div className="border-bengal-blue bg-polar-mist rounded border p-6">
            ...
            <p className="text-deep-sapphire text-base leading-relaxed">
              ...
              environment designed to foster healing and growth. Let us walk with you towards
              finding peace, understanding, and renewed hope.
            </p>
          </div>
        </div>
        ...
        <div className="mb-10 grid grid-cols-1 gap-6 md:grid-cols-2">
          <div className="border-bengal-blue bg-polar-mist rounded border p-6">
            ...
            <p className="text-deep-sapphire text-base leading-relaxed">
              ...
              Whether you&apos;re seeking support for personal challenges or looking to strengthen
        ...
        <div className="mb-10 grid grid-cols-1 gap-6 md:grid-cols-2">
          ...
          <div className="border-bengal-blue bg-polar-mist rounded border p-6">
            ...
            <p className="text-deep-sapphire text-base leading-relaxed">
              ...
              designed to ease your concerns, clarify the counseling process, and help you
              understand how Compass Christian Counseling can support you on your journey to
              wellness.
            </p>
          </div>
        </div>
        ...
        <div className="mb-10 grid grid-cols-1 gap-6 md:grid-cols-2">
          <div className="border-bengal-blue bg-polar-mist rounded border p-6">
            ...
            <p className="text-deep-sapphire text-base leading-relaxed">
              ...
              various life issues. This page is designed to provide immediate help and ongoing
              support for anyone needing assistance or seeking to deepen their understanding of
              personal challenges.
            </p>
          </div>
          <div className="relative min-h-48 overflow-hidden rounded">
        ...
        <div className="mb-10 grid grid-cols-1 gap-6 md:grid-cols-2">
          ...
          <div className="border-bengal-blue bg-polar-mist rounded border p-6">
            ...
            <p className="text-deep-sapphire text-base leading-relaxed">
              ...
              ensuring you can locate us easily for your appointments. This page is your gateway to
              connecting with our supportive team and starting your journey toward healing.
            </p>
          </div>
        </div>
      </div>
