      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div className="flex flex-col gap-4">
          <Card>
            ...
            <CardBody>
              <p className="text-deep-sapphire text-sm">
                Each individual is unique, with their own experiences, interpretations, and beliefs.
                A variety of circumstances can keep us from experiencing freedom and enjoyment of
                life. We want to carefully collaborate with you to build hope and purpose in your
                heart, your life and your relationships, restoring freedom and enjoyment.
              </p>
            </CardBody>
          </Card>
          ...
          <Card>
            ...
            <CardBody>
              <p className="text-deep-sapphire text-sm">
                Arguments, disagreements, loneliness, and hurt&hellip; there is nothing more joyful
                when our primary relationships are working well, and nothing more painful when they
                are not! In couples therapy our focus will be to understand what is going on,
                particularly as it relates to the patterns that exist in the relationship and then,
                we&apos;ll work to de-escalate negative cycles and introduce new patterns of
          ...
          <Card>
            ...
            <CardBody>
              <p className="text-deep-sapphire text-sm">
                ...
                insight into family dynamics. Family therapy helps promote greater encouragement and
                support among all members of the family.
              </p>
            </CardBody>
          </Card>
