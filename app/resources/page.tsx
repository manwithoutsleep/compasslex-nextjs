        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            ...
            <Card>
              ...
              <CardBody>
                <dl className="space-y-2">
                  <dt className="text-deep-sapphire font-semibold">SUICIDE HOTLINE</dt>
                  <dd className="text-deep-sapphire">1-800-SUICIDE</dd>
                  <dt className="text-deep-sapphire font-semibold">Sexual Assault Hotline</dt>
                  <dd className="text-deep-sapphire">1-800-656-HOPE</dd>
                </dl>
                <p className="text-deep-sapphire mt-4 text-sm">
                  For immediate help dial 911 or visit the nearest Hospital Emergency Room
                </p>
              </CardBody>
            </Card>
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <Card>
              ...
              <CardBody>
                <p className="text-deep-sapphire mb-3 text-sm">
                  You can access Compass Articles on a variety of mental health topics such as
                  boundaries, grief, perfectionism, etc. We hope that the articles written by
                  Compass Christian Counseling staff will be helpful to you.
                </p>
                <Link
                  href="/newsletters"
                  className="text-deep-sapphire underline hover:text-royal-indigo"
          ...
          <div className="flex flex-col gap-4">
            ...
            <Card>
              ...
              <CardBody>
                <p className="text-deep-sapphire mb-3 text-sm">Recommended Books on Life Issues</p>
                <div className="flex flex-col gap-2">
                  <a
