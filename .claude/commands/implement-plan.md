...
<instruction>After implementation, use the verify-code skill to ensure TypeScript, formatting, and testing issues are identified and resolved. This ensures code quality and prevents accumulation of technical debt.</instruction>
