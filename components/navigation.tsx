...
export default function Navigation({ isMobile, isOpen = false, onClose }: NavigationProps) {
  ...
  return (
    <>
      ...
      {/* Sidenav */}
      <nav
        className={`bg-pure-white fixed top-[60px] left-0 z-[1100] h-[calc(100vh-60px)] w-[155px] shadow-[0_8px_10px_-5px_rgba(0,0,0,0.2),0_16px_24px_2px_rgba(0,0,0,0.14),0_6px_30px_5px_rgba(0,0,0,0.12)] transition-transform duration-300 ease-in-out min-[600px]:hidden ${
